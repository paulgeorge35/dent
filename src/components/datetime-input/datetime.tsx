    ...
    <div {...calendarProps} className="space-y-4">
      <div className="relative flex items-center justify-center pt-1">
        <Button
          ...
          size="icon"
          className={cn(
            "absolute left-1 bg-transparent p-0 opacity-50 hover:opacity-100",
          )}
        >
        ...
        <Button
          ...
          size="icon"
          className={cn(
            "absolute right-1 bg-transparent p-0 opacity-50 hover:opacity-100",
          )}
        >
...
function CalendarGrid({ state, ...props }: CalendarGridProps) {
  ...
  const weeksInMonth = getWeeksInMonth(state.visibleRange.start, "en-GB");
