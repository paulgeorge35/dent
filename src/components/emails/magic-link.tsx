    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={message}>
          <Heading style={global.heading}>Sign in to your account</Heading>
          <Text style={global.text}>
            You can sign in to your account by clicking the link below:
          </Text>
          <Link style={{ ...marginY, ...global.link }} href={url}>
            Sign in to your account
          </Link>
          <Text style={footer.text}>This link will expire in 15 minutes.</Text>
        </Section>
