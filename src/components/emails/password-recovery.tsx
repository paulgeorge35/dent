...
export const PasswordRecovery = ({ name, url }: PasswordRecoveryProps) => (
  <Html>
    <Head>
      <Preview>
        You&apos;ve requested a password recovery for MyDent. Click the link
    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={message}>
          <Heading style={global.heading}>Password Recovery</Heading>
